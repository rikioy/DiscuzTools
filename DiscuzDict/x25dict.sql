...
-- 数据库: `x25dict`
--
CREATE DATABASE IF NOT EXISTS `x25dict` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `x25dict`;
...
CREATE TABLE IF NOT EXISTS `pre_common_admincp_cmenu` (
  ...
  `dateline` int(10) unsigned NOT NULL COMMENT '添加时间12',
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`),
  KEY `displayorder` (`displayorder`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='后台菜单收藏表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='后台管理组' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_admincp_member` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='后台管理成员';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='后台权限表';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='后台session表';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='管理组表';
...
CREATE TABLE IF NOT EXISTS `pre_common_adminnote` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='后台留言表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_advertisement` (
  ...
  PRIMARY KEY (`advid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='广告数据表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_advertisement_custom` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='自定义广告数据表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_banned` (
  ...
  `expiration` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '过期时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='禁止访问表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_block` (
  ...
  PRIMARY KEY (`bid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模块表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模块收藏表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_block_item` (
  ...
  PRIMARY KEY (`itemid`),
  KEY `bid` (`bid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模块数据表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模块推荐信息表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_block_permission` (
  ...
  PRIMARY KEY (`bid`,`uid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模块权限表';
...
CREATE TABLE IF NOT EXISTS `pre_common_block_pic` (
  ...
  PRIMARY KEY (`picid`),
  KEY `bid` (`bid`,`itemid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模块使用图片表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模块模板表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_block_xml` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模块 XML 扩展类数据表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='通用缓存表';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='充值卡密表';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='充值卡密日志表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_card_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='卡片分类表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_credit_log` (
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='积分日志表';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='积分规则表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_credit_rule_log` (
  ...
  KEY `uid` (`uid`,`rid`,`fid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='积分规则日志表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='积分规则日志扩展表';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='计划任务表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='地区表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_diy_data` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='DIY模板页面数据的存档表';
...
CREATE TABLE IF NOT EXISTS `pre_common_domain` (
  ...
  KEY `idtype` (`idtype`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='二级域名表';
...
CREATE TABLE IF NOT EXISTS `pre_common_failedlogin` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='失败登录表';
...
CREATE TABLE IF NOT EXISTS `pre_common_friendlink` (
  ...
  `type` tinyint(3) NOT NULL DEFAULT '0' COMMENT '友情链接分组，二进制位',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='友情链接表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_grouppm` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='群发短消息表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_invite` (
  ...
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '邮件邀请 1 是 0 否',
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='邀请表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_magic` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='道具数据表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_magiclog` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  ...
  `idtype` char(6) DEFAULT NULL COMMENT 'ID类型',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='道具日志表';
...
CREATE TABLE IF NOT EXISTS `pre_common_mailcron` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='邮件计划任务表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_mailqueue` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='邮件队列表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户主表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_member_action_log` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户操作日志表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_member_count` (
  ...
  PRIMARY KEY (`uid`),
  KEY `posts` (`posts`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户统计表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_crime` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户惩罚操作表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_member_field_forum` (
  `uid` mediumint(8) unsigned NOT NULL COMMENT '会员id',
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户论坛字段表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_field_home` (
  `uid` mediumint(8) unsigned NOT NULL COMMENT '会员id',
  ...
  PRIMARY KEY (`uid`),
  KEY `domain` (`domain`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户家园字段表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_grouppm` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='群发短消息用户记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_member_log` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `action` char(10) NOT NULL DEFAULT '' COMMENT 'add,update,delete',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='漫游用户日志表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_magic` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户道具数据表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_medal` (
  `uid` mediumint(8) unsigned NOT NULL COMMENT '用户ID',
  `medalid` smallint(6) unsigned NOT NULL COMMENT '勋章ID',
  PRIMARY KEY (`uid`,`medalid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户勋章数据表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_profile` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户栏目表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_profile_setting` (
  ...
  PRIMARY KEY (`fieldid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='个人信息扩展表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_security` (
  ...
  KEY `uid` (`uid`,`fieldid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='个人信息修改审核' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_member_status` (
  `uid` mediumint(8) unsigned NOT NULL COMMENT '会员id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户状态表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_stat_field` (
  ...
  KEY `fieldid` (`fieldid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户资料统计项' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_member_validate` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  ...
  PRIMARY KEY (`uid`),
  KEY `status` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户审核表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_verify` (
  ...
  KEY `verify6` (`verify6`),
  KEY `verify7` (`verify7`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户认证表';
...
CREATE TABLE IF NOT EXISTS `pre_common_member_verify_info` (
...
CREATE TABLE IF NOT EXISTS `pre_common_myapp` (
  `appid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '应用id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='漫游应用表';
...
CREATE TABLE IF NOT EXISTS `pre_common_myinvite` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户邀请表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_mytask` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='我的任务表';
...
CREATE TABLE IF NOT EXISTS `pre_common_nav` (
  ...
  PRIMARY KEY (`id`),
  KEY `navtype` (`navtype`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='自定义导航栏表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_onlinetime` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `thismonth` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '本月时间',
  `total` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '总计时间',
  `lastupdate` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上次更新',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='在线时间表';
...
CREATE TABLE IF NOT EXISTS `pre_common_patch` (
  ...
  PRIMARY KEY (`serial`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='漏洞补丁表';
...
CREATE TABLE IF NOT EXISTS `pre_common_plugin` (
  ...
  UNIQUE KEY `identifier` (`identifier`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='插件表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_pluginvar` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='插件变量表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_process` (
  ...
  KEY `expiry` (`expiry`)
) ENGINE=MEMORY DEFAULT CHARSET=latin1 COMMENT='进程锁管理';
...
CREATE TABLE IF NOT EXISTS `pre_common_regip` (
  ...
  KEY `ip` (`ip`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='注册IP限制表';
...
CREATE TABLE IF NOT EXISTS `pre_common_relatedlink` (
  `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(100) NOT NULL DEFAULT '' COMMENT '名称',
  `url` varchar(255) NOT NULL DEFAULT '' COMMENT 'url',
  `extent` tinyint(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='关联链接表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_report` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录id',
  ...
  KEY `urlkey` (`urlkey`),
  KEY `fid` (`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户举报表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `pre_common_searchindex`
--

CREATE TABLE IF NOT EXISTS `pre_common_searchindex` (
  ...
  KEY `srchmod` (`srchmod`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='搜索缓存表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_secquestion` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='验证问题数据表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_session` (
  ...
  UNIQUE KEY `sid` (`sid`),
  KEY `uid` (`uid`)
) ENGINE=MEMORY DEFAULT CHARSET=latin1 COMMENT='会员认证表';
...
CREATE TABLE IF NOT EXISTS `pre_common_setting` (
  ...
  PRIMARY KEY (`skey`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='设置表';
...
CREATE TABLE IF NOT EXISTS `pre_common_smiley` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='表情表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `pre_common_sphinxcounter`
--

CREATE TABLE IF NOT EXISTS `pre_common_sphinxcounter` (
  `indexid` tinyint(1) NOT NULL,
  `maxid` int(10) NOT NULL,
  PRIMARY KEY (`indexid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Sphinx 增量索引记录表';
...
CREATE TABLE IF NOT EXISTS `pre_common_stat` (
  ...
  PRIMARY KEY (`daytime`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='趋势统计';
...
CREATE TABLE IF NOT EXISTS `pre_common_style` (
  ...
  PRIMARY KEY (`styleid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='风格表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_stylevar` (
  ...
  KEY `styleid` (`styleid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='风格变量表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_syscache` (
  ...
  PRIMARY KEY (`cname`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='缓存数据表';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='标签表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_tagitem` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='标签内容表';
...
CREATE TABLE IF NOT EXISTS `pre_common_task` (
  ...
  PRIMARY KEY (`taskid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='论坛任务表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_taskvar` (
  ...
  KEY `taskid` (`taskid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='论坛任务设置表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_template` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模板表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_template_block` (
  `targettplname` varchar(100) NOT NULL DEFAULT '' COMMENT '目标模板文件名',
  `tpldirectory` varchar(80) NOT NULL DEFAULT '' COMMENT '原模板所在目录',
  `bid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '模块ID',
  PRIMARY KEY (`targettplname`,`tpldirectory`,`bid`),
  KEY `bid` (`bid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='模板页面和模块的关联表';
...
CREATE TABLE IF NOT EXISTS `pre_common_template_permission` (
  ...
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='DIY模板页面权限表';
...
CREATE TABLE IF NOT EXISTS `pre_common_usergroup` (
  ...
  `icon` varchar(255) NOT NULL DEFAULT '' COMMENT '用户组图标路径',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户组表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_usergroup_field` (
  ...
  PRIMARY KEY (`groupid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='会员用户组权限表';
...
CREATE TABLE IF NOT EXISTS `pre_common_word` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='词语过滤表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_common_word_type` (
  `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT COMMENT '词语过滤分类id',
  `typename` varchar(15) NOT NULL DEFAULT '' COMMENT '分类名称',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='词语过滤分类' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_access` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  `fid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '论坛id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='访问权限表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_activity` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='活动表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_activityapply` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='活动申请表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_announcement` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='公告表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_attachment` (
  ...
  KEY `pid` (`pid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='附件索引表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `pre_forum_attachment_0`
--
...
CREATE TABLE IF NOT EXISTS `pre_forum_attachment_0` (
  ...
  KEY `pid` (`pid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='附件表';

-- --------------------------------------------------------

--
-- 表的结构 `pre_forum_attachment_1`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_1` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
--
-- 表的结构 `pre_forum_attachment_2`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_2` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
--
-- 表的结构 `pre_forum_attachment_3`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_3` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
--
-- 表的结构 `pre_forum_attachment_4`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_4` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
--
-- 表的结构 `pre_forum_attachment_5`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_5` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
--
-- 表的结构 `pre_forum_attachment_6`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_6` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
--
-- 表的结构 `pre_forum_attachment_7`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_7` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
--
-- 表的结构 `pre_forum_attachment_8`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_8` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
--
-- 表的结构 `pre_forum_attachment_9`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_9` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
...
--
-- 表的结构 `pre_forum_attachment_exif`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_exif` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `exif` text NOT NULL COMMENT 'exif信息',
  PRIMARY KEY (`aid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Exif缓存表';

-- --------------------------------------------------------

--
-- 表的结构 `pre_forum_attachment_unused`
--

CREATE TABLE IF NOT EXISTS `pre_forum_attachment_unused` (
  `aid` mediumint(8) unsigned NOT NULL COMMENT '附件id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上传时间',
  `filename` varchar(255) NOT NULL DEFAULT '' COMMENT '原文件名',
  ...
  PRIMARY KEY (`aid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='未使用附件表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_attachtype` (
  ...
  PRIMARY KEY (`id`),
  KEY `fid` (`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='附件类型表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_bbcode` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Discuz! 代码表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_collection` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='淘帖专辑表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_collectioncomment` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='淘帖评论表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_collectionfollow` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `username` char(15) NOT NULL DEFAULT '' COMMENT '用户名',
  `ctid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '专辑ID',
  ...
  KEY `ctid` (`ctid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='淘帖关注表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_collectioninvite` (
  `ctid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '专辑ID',
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='邀请管理淘专辑';
...
CREATE TABLE IF NOT EXISTS `pre_forum_collectionrelated` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题ID',
  `collection` text NOT NULL COMMENT '专辑列表',
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='淘帖主题被收入专辑表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_collectionteamworker` (
  `ctid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '专辑ID',
  ...
  PRIMARY KEY (`ctid`,`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='淘帖合作编辑表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_collectionthread` (
  `ctid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '专辑ID',
  ...
  KEY `ctid` (`ctid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='淘帖包含主题表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_creditslog` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  ...
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='转帐记录表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_debate` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='辩论主题表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_debatepost` (
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  ...
  KEY `pid` (`pid`,`stand`),
  KEY `tid` (`tid`,`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='辩论帖子表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_faq` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='论坛帮助表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_forum` (
  ...
  `type` enum('group','forum','sub') NOT NULL DEFAULT 'forum' COMMENT '类型(group:分类 forum:普通论坛 sub:子论坛)',
  `name` char(50) NOT NULL DEFAULT '' COMMENT '名称',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '显示状态\n(0:隐藏 1:正常 3:群组)',
  `displayorder` smallint(6) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  `styleid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '风格id',
  ...
  KEY `fup` (`fup`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='版块表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_forumfield` (
  `fid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '版块id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='版块扩展表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_forumrecommend` (
  `fid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '版块id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='版主推荐表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_forum_threadtable` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='版块存档信息';
...
CREATE TABLE IF NOT EXISTS `pre_forum_groupcreditslog` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='群组积分日志表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_groupfield` (
  ...
  KEY `fid` (`fid`),
  KEY `type` (`type`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='群组扩展信息缓存';

-- --------------------------------------------------------

--
-- 表的结构 `pre_forum_groupinvite`
--

CREATE TABLE IF NOT EXISTS `pre_forum_groupinvite` (
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='群组邀请';
...
CREATE TABLE IF NOT EXISTS `pre_forum_grouplevel` (
  ...
  PRIMARY KEY (`levelid`),
  KEY `creditsrange` (`creditshigher`,`creditslower`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='群组等级表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_groupuser` (
  `fid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '群组关联fid',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='群组成员';
...
CREATE TABLE IF NOT EXISTS `pre_forum_imagetype` (
  ...
  PRIMARY KEY (`typeid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='图片 表情 头像等 分类' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_medal` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='勋章表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_medallog` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录id',
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='勋章日志表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_memberrecommend` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户推荐表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_moderator` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  `fid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '论坛id',
  `displayorder` tinyint(3) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  `inherited` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否继承',
  PRIMARY KEY (`uid`,`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='版主表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_modwork` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  ...
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='论坛管理统计表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_onlinelist` (
  `groupid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '会员组id',
  `displayorder` tinyint(3) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  `title` varchar(30) NOT NULL DEFAULT '' COMMENT '组名称',
  `url` varchar(30) NOT NULL DEFAULT '' COMMENT '图例URL'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='在线列表定制';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='订单信息表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_poll` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='投票表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_polloption` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='投票选项表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_pollvoter` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  ...
  KEY `tid` (`tid`),
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='投票用户表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_post` (
  ...
  `invisible` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否通过审核 0正常;-1回收站;-2审核中;-3审核忽略/草稿;-4 N/A;-5 回收站回帖',
  ...
  `attachment` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 无附件; 1有附件 ;2有图片附件',
  `rate` smallint(6) NOT NULL DEFAULT '0' COMMENT '评分分数',
  `ratetimes` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '评分次数',
  `status` int(10) NOT NULL DEFAULT '0' COMMENT ' (位运算存储 0x00000000 - FFFFFFFF 总共支持32个标志位，其中)    2109 8765 4321 0987 6543 2109 8765 4321 序号 #B 0000 0000 0000 0000 0000 0000 0000 0001 帖子被屏蔽 #B 0000 0000 0000 0000 0000 0000 0000 0010 帖子被警告 #B 0000 0000 0000 0000 0000 0000 0000 0100 帖子审核后再编辑标记，用于防止重复加分 #B 0000 0000 0000 0000 0000 0000 0000 1000 手机版发帖标示 #B 0000 0000 0000 0000 0000 0000 0001 0000 微博回流的帖子标记 #B 0000 0000 0000 0000 0000 0000 0010 0000 [手机]是否显示地理位置 #B 0000 0000 0000 0000 0000 0000 0100 0000 [手机]含手机录音 #B 0000 0000 0000 0000 0000 0000 1000 0000 [手机型号(联动)] 001(1):iOS #B 0000 0000 0000 0000 0000 0001 0000 0000 [手机型号(联动)] 010(2):Android 011(3):WindowsPhone #B 0000 0000 0000 0000 0000 0010 0000 0000 [手机型号(联动)] 100:',
  ...
  KEY `first` (`tid`,`first`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='帖子表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_postcache` (
  ...
  PRIMARY KEY (`pid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='论坛帖子缓存表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_postcomment` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='点评帖子表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_postlog` (
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `fid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '版块id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `action` char(10) NOT NULL DEFAULT '' COMMENT '操作动作',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '操作时间',
  PRIMARY KEY (`pid`,`tid`),
  KEY `fid` (`fid`),
  KEY `uid` (`uid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='漫游帖子日志';
...
CREATE TABLE IF NOT EXISTS `pre_forum_poststick` (
  ...
  PRIMARY KEY (`tid`,`pid`),
  KEY `dateline` (`tid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='回帖置顶表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_post_location` (
  ...
  KEY `tid` (`tid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='帖子地理位置表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_post_moderate` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='帖子审核数据表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_post_tableid` (
  `pid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Post ID',
  PRIMARY KEY (`pid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='post分表协调表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_promotion` (
  `ip` char(15) NOT NULL DEFAULT '' COMMENT 'IP地址',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  `username` char(15) NOT NULL DEFAULT '' COMMENT '会员名',
  PRIMARY KEY (`ip`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='论坛推广';
...
CREATE TABLE IF NOT EXISTS `pre_forum_ratelog` (
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  `username` char(15) NOT NULL DEFAULT '' COMMENT '会员名',
  ...
  KEY `dateline` (`dateline`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='帖子评分记录表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_relatedthread` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='相关主题表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_replycredit` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='主题回帖获得积分规则表';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='rss缓存表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_spacecache` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='minispace缓存表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_statlog` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='版块统计日志表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_thread` (
  ...
  `displayorder` tinyint(1) NOT NULL DEFAULT '0' COMMENT '4 跨版块置顶;3 3级置顶;2 2级置顶;1 1级置顶;0正常;-1回收站;-2审核中;-3审核忽略;-4草稿',
  ...
  `status` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT ' forum_thread 的 status 字段备注 (位运算存储 0x0000 - FFFF 总共支持16个标志位，其中)    6543 2109 8765 4321 序号 #B 0000 0000 0000 0001 是否缓存帖子位置信息 #B 0000 0000 0000 0010 是否回帖只对管理人员和发帖者可见 #B 0000 0000 0000 0100 是否抢楼贴 #B 0000 0000 0000 1000 是否倒序查看回帖 #B 0000 0000 0001 0000 是否存在主题图章标志位 #B 0000 0000 0010 0000 回复是否通知作者 #B 0000 0000 0100 0000 是否需要推送到QQ空间 #B 0000 0000 1000 0000 是否需要推送到腾讯微博 #B 0000 0001 0000 0000 是否被收入专辑 #B 0000 0010 0000 0000 是否被转播 #B 0000 0100 0000 0000 [手机标识(联动)] 001(1):含手机文本 #B 0000 1000 0000 0000 [手机标识(联动)] 010(2):含地理位置 011(3):含手机照片 #B 0001 0000 0000 0000 [手机标识(联动)] 100(4):含手机录音 #B 0010 0000 0000 0000 是否成功推送到腾讯微博',
  ...
  KEY `special` (`special`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='主题表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_threadaddviews` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `addviews` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '浏览次数',
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='主题查看数延时更新表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_threadclass` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='主题分类表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `pre_forum_threadclosed`
--

CREATE TABLE IF NOT EXISTS `pre_forum_threadclosed` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='主题转移后保留的指向记录';

-- --------------------------------------------------------

--
-- 表的结构 `pre_forum_threaddisablepos`
--

CREATE TABLE IF NOT EXISTS `pre_forum_threaddisablepos` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  PRIMARY KEY (`tid`)
) ENGINE=MEMORY DEFAULT CHARSET=latin1 COMMENT='主题有楼层不准确时不使用position查询';

-- --------------------------------------------------------

--
-- 表的结构 `pre_forum_threadimage`
--

CREATE TABLE IF NOT EXISTS `pre_forum_threadimage` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `attachment` varchar(255) NOT NULL DEFAULT '' COMMENT '服务器路径',
  `remote` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否远程附件',
  KEY `tid` (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='主题图片表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_threadlog` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `fid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '版块id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `otherid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '其他id',
  `action` char(10) NOT NULL COMMENT '操作动作',
  `expiry` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '有效期',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '操作时间',
  PRIMARY KEY (`tid`,`fid`,`uid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='漫游主题日志';
...
CREATE TABLE IF NOT EXISTS `pre_forum_threadmod` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  `username` char(15) NOT NULL DEFAULT '' COMMENT '会员名',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '操作时间',
  ...
  `reason` char(40) NOT NULL DEFAULT '' COMMENT '原因',
  KEY `tid` (`tid`,`dateline`),
  KEY `expiration` (`expiration`,`status`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='主题管理记录表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_threadpartake` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '参与时间',
  KEY `tid` (`tid`,`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='主题参与者记录表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_threadpreview` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题ID',
  `relay` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '转播次数',
  `content` text NOT NULL COMMENT '主题内容预览',
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='服务于广播';
...
CREATE TABLE IF NOT EXISTS `pre_forum_threadrush` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='抢楼设置表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_threadtype` (
  ...
  PRIMARY KEY (`typeid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='分类信息表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_thread_moderate` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ID',
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态 0 审核中，1 已忽略',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='主题审核数据表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_trade` (
  `tid` mediumint(8) unsigned NOT NULL COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL COMMENT '帖子id',
  ...
  KEY `expiration` (`expiration`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='商品数据表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_tradecomment` (
  ...
  KEY `orderid` (`orderid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='信用评价' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_tradelog` (
  `tid` mediumint(8) unsigned NOT NULL COMMENT '主题id',
  `pid` int(10) unsigned NOT NULL COMMENT '帖子id',
...
CREATE TABLE IF NOT EXISTS `pre_forum_typeoption` (
  ...
  PRIMARY KEY (`optionid`),
  KEY `classid` (`classid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='分类信息设置项目表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_forum_typeoptionvar` (
  `sortid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '分类信息id',
  ...
  KEY `tid` (`tid`),
  KEY `fid` (`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='分类信息项目数据表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_typevar` (
  ...
  KEY `sortid` (`sortid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='分类信息对应项目表';
...
CREATE TABLE IF NOT EXISTS `pre_forum_warning` (
  ...
  UNIQUE KEY `pid` (`pid`),
  KEY `authorid` (`authorid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='警告记录表' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='相册表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_album_category` (
  ...
  `displayorder` smallint(6) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  PRIMARY KEY (`catid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='相册系统栏目' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_appcreditlog` (
  ...
  KEY `uid` (`uid`,`dateline`),
  KEY `appid` (`appid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='漫游应用积分操作记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_blacklist` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID ',
  ...
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='屏蔽黑名单表';
...
CREATE TABLE IF NOT EXISTS `pre_home_blog` (
  ...
  KEY `hot` (`hot`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='日志表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_blogfield` (
  ...
  PRIMARY KEY (`blogid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='日志字段表';
...
CREATE TABLE IF NOT EXISTS `pre_home_blog_category` (
  `catid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '栏目id',
  `upid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '上级栏目id',
  `catname` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  ...
  `displayorder` smallint(6) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  PRIMARY KEY (`catid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='日志系统栏目' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_blog_moderate` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ID',
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态 0 审核中，1 已忽略',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='日志审核数据表';
...
CREATE TABLE IF NOT EXISTS `pre_home_class` (
  ...
  PRIMARY KEY (`classid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='日志个人分类表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_click` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='表态动作' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_clickuser` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户表态表';
...
CREATE TABLE IF NOT EXISTS `pre_home_comment` (
  `cid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论id',
  ...
  KEY `id` (`id`,`idtype`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户评论表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_comment_moderate` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ID',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='家园评论审核数据表';
...
CREATE TABLE IF NOT EXISTS `pre_home_docomment` (
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户记录回复表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_doing` (
  ...
  KEY `uid` (`uid`,`dateline`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_doing_moderate` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ID',
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态 0 审核中，1 已忽略',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='记录审核数据表';
...
CREATE TABLE IF NOT EXISTS `pre_home_favorite` (
  `favid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '收藏id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '会员id',
  ...
  KEY `uid` (`uid`,`idtype`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='收藏表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_feed` (
  ...
  KEY `hot` (`hot`),
  KEY `id` (`id`,`idtype`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='站点feed表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_feed_app` (
  ...
  KEY `uid` (`uid`,`dateline`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='应该feed表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_follow` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `username` char(15) NOT NULL DEFAULT '' COMMENT '用户名',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户关注关系表';
...
CREATE TABLE IF NOT EXISTS `pre_home_follow_feed` (
  ...
  PRIMARY KEY (`feedid`),
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='被关注者事件表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_follow_feed_archiver` (
  `feedid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '被关注者ID',
  `username` varchar(15) NOT NULL DEFAULT '' COMMENT '被关注用户名',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '帖子tid',
  ...
  PRIMARY KEY (`feedid`),
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='被关注者事件存档' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_friend` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID ',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户好友表';
...
CREATE TABLE IF NOT EXISTS `pre_home_friendlog` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID ',
  ...
  PRIMARY KEY (`uid`,`fuid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户好友动作日志表';
...
CREATE TABLE IF NOT EXISTS `pre_home_friend_request` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID ',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='申请好友表';
...
CREATE TABLE IF NOT EXISTS `pre_home_notification` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='通知表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_pic` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='家园图片表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_picfield` (
  `picid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '图片id',
  `hotuser` text NOT NULL COMMENT '图片对应热点用户',
  PRIMARY KEY (`picid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='家园图片拓展表';
...
CREATE TABLE IF NOT EXISTS `pre_home_pic_moderate` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ID',
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态 0 审核中，1 已忽略',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='图片审核数据表';
...
CREATE TABLE IF NOT EXISTS `pre_home_poke` (
  ...
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户招呼表';
...
CREATE TABLE IF NOT EXISTS `pre_home_pokearchive` (
  `pid` mediumint(8) NOT NULL AUTO_INCREMENT COMMENT '招呼历史id',
  `pokeuid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'uid + fromuid',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '目标用户ID',
  `fromuid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '发起用户ID',
  `note` varchar(255) NOT NULL DEFAULT '' COMMENT '招呼内容',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '招呼时间戳',
  `iconid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '招呼图标',
  PRIMARY KEY (`pid`),
  KEY `pokeuid` (`pokeuid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户招呼存档表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_share` (
  ...
  KEY `hot` (`hot`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户分享表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_home_share_moderate` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ID',
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态 0 审核中，1 已忽略',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='分享审核数据表';
...
CREATE TABLE IF NOT EXISTS `pre_home_show` (
  ...
  KEY `credit` (`credit`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户上榜表';
...
CREATE TABLE IF NOT EXISTS `pre_home_specialuser` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `username` varchar(15) NOT NULL DEFAULT '' COMMENT '用户名',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='特殊用户表';
...
CREATE TABLE IF NOT EXISTS `pre_home_userapp` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户使用应用表';
...
CREATE TABLE IF NOT EXISTS `pre_home_userappfield` (
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '使用应用的用户id',
  `appid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '应用id',
  `profilelink` text NOT NULL COMMENT '应用链接',
  `myml` text NOT NULL COMMENT 'myml格式的首页显示信息',
  KEY `uid` (`uid`,`appid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='用户使用应用扩展表';
...
CREATE TABLE IF NOT EXISTS `pre_home_visitor` (
  ...
  KEY `vuid` (`vuid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='空间访问日志表';
...
CREATE TABLE IF NOT EXISTS `pre_portal_article_content` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='门户文章内容表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_portal_article_count` (
  `aid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '文章ID',
  ...
  PRIMARY KEY (`aid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='门户文章统计数据表';
...
CREATE TABLE IF NOT EXISTS `pre_portal_article_moderate` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ID',
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态 0 审核中，1 已忽略',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='文章审核数据表';
...
CREATE TABLE IF NOT EXISTS `pre_portal_article_related` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='门户相关文章' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_portal_article_title` (
  `aid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '文章ID',
  `catid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '栏目id',
  `bid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '模块id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='门户文章标题表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_portal_attachment` (
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='门户文章附件表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_portal_category` (
  `catid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '栏目id',
  `upid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '上级栏目id',
  `catname` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  ...
  PRIMARY KEY (`catid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='门户 文章栏目表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_portal_category_permission` (
  ...
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='文章分类权限表';
...
CREATE TABLE IF NOT EXISTS `pre_portal_comment` (
  `cid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论id',
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '发表评论的用户id',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='门户评论表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_portal_comment_moderate` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ID',
  `idtype` varchar(15) NOT NULL DEFAULT '' COMMENT 'ID类型',
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态 0 审核中，1 已忽略',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idtype` (`idtype`,`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='文章/专题评论审核数据表';
...
CREATE TABLE IF NOT EXISTS `pre_portal_rsscache` (
  `lastupdate` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '最后更新时间',
  ...
  UNIQUE KEY `aid` (`aid`),
  KEY `catid` (`catid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='文章rss缓存表';
...
CREATE TABLE IF NOT EXISTS `pre_portal_topic` (
  ...
  PRIMARY KEY (`topicid`),
  KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='门户专题表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pre_portal_topic_pic` (
  `picid` mediumint(8) NOT NULL AUTO_INCREMENT COMMENT '图片ID ',
  ...
  PRIMARY KEY (`picid`),
  KEY `topicid` (`topicid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='门户专题图片表' AUTO_INCREMENT=1 ;
